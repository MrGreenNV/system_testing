...
public class ConstNameWindows {
    ...
    public static final String WINDOW_CHANGE_DISCIPLINES = "changeDisciplines.fxml";
    public static final String WINDOW_CHANGE_GROUPS = "changeGroups.fxml";
    public static final String WINDOW_DELETE_USER = "deleteUser.fxml";
    ...
    public static final String WINDOW_PASS_TEST = "passTest.fxml";
